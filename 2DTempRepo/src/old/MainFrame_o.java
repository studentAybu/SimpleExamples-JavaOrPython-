...
class MainPanel extends JPanel{
    ...
    public void construct2D(Graphics2D graphics){
        ...
        for(int i=0;i<Shape2DList.size();i++){
            ...
            Coordinate_o lastCoordinate = shape.verticesList.get(shape.verticesList.size()-1);
...
public class MainFrame_o extends JFrame {
    MainPanel panel;
    MainFrame_o(){
        panel = new MainPanel();
